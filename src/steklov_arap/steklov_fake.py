...
class ARAPManagerSteklov:
    ...
    def __init__(
        ...
        self.mass = None
        self.laplacian_cpu = None
        self.bisteklov_cpu = None
        self.L = None
        self.L_row_sum = None
    ...
    def _update_operator(self):
        ...
        self.steklov_evals = cached_dtn["evals_int"].to(dtype=self.V_rest.dtype, device="cpu")
        self.steklov_evecs = cached_dtn["evecs_int"].to(dtype=self.V_rest.dtype, device="cpu")
        self.steklov_stiffness = cached_dtn["S_int"].to(dtype=self.V_rest.dtype, device="cpu")
        self.mass = cached_dtn["mass"].to(dtype=self.V_rest.dtype, device="cpu")
